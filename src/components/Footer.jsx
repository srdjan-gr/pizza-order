...
const Footer = () => {
  ...
  return (
    <section className={`${path === '/login' || path === '/register' ? 'absolute bottom-0 left-0 z-50' : '' } bg-white w-full text-gray-800 flex justify-center items-center flex-col p-4 custom_shadow-top`}>
