    ...
    >
        ...
        <div className='w-full absolute bottom-1/2 left-0 translate-y-1/2'>
            <div className="max-w-7xl m-auto ">
                {/* <h1 className='text-6xl font-bold leading-tight'>Perfect Place <br /> for <span className='text-pizza_green-500'>Perfect</span>  <span className='text-pizza_orange-500'>Pizza</span> </h1> */}
